...
package body Semihosting is
   ...
   SYS_EXIT   : constant := 16#18#;  --  Exit (angel_SWIreason_ReportException)

   --  ADP_Stopped_ApplicationExit reason code
   ADP_Stopped_ApplicationExit : constant := 16#20026#;
   ...
   procedure Exit_App (Exit_Code : Unsigned_32) is
      --  Parameter block for SYS_EXIT: [reason, exit_code]
      Params : aliased array (0 .. 1) of Unsigned_32 :=
        [ADP_Stopped_ApplicationExit, Exit_Code];
   begin
      Semihost_Call (SYS_EXIT, Params'Address);
