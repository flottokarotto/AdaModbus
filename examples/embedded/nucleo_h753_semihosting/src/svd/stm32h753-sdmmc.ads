...
package STM32H753.SDMMC is
   ...
   subtype POWER_PWRCTRL_Field is STM32H753.UInt2;
   ...
   subtype CLKCR_CLKDIV_Field is STM32H753.UInt10;
   subtype CLKCR_WIDBUS_Field is STM32H753.UInt2;
   subtype CLKCR_SELCLKRX_Field is STM32H753.UInt2;
   ...
   subtype CMDR_CMDINDEX_Field is STM32H753.UInt6;
   subtype CMDR_WAITRESP_Field is STM32H753.UInt2;
   ...
   subtype RESPCMDR_RESPCMD_Field is STM32H753.UInt6;
   ...
   subtype DLENR_DATALENGTH_Field is STM32H753.UInt25;
   ...
   subtype DCTRL_DTMODE_Field is STM32H753.UInt2;
   subtype DCTRL_DBLOCKSIZE_Field is STM32H753.UInt4;
   ...
   subtype DCNTR_DATACOUNT_Field is STM32H753.UInt25;
   ...
   type STAR_Register is record
      ...
      IDMABTC        : Boolean;
      --  unspecified
      Reserved_29_31 : STM32H753.UInt3;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type ICR_Register is record
      ...
      --  unspecified
      Reserved_12_20 : STM32H753.UInt9 := 16#0#;
   ...
   type MASKR_Register is record
      ...
      --  unspecified
      Reserved_19_20 : STM32H753.UInt2 := 16#0#;
   ...
   subtype ACKTIMER_ACKTIME_Field is STM32H753.UInt25;
   ...
   subtype IDMABSIZER_IDMABNDT_Field is STM32H753.Byte;
   ...
   subtype VER_MINREV_Field is STM32H753.UInt4;
   subtype VER_MAJREV_Field is STM32H753.UInt4;
   ...
   type SDMMC_Peripheral is record
      ...
      RESP1R     : aliased STM32H753.UInt32;
      --  The SDMMC_RESP1/2/3/4R registers contain the status of a card, which
      --  is part of the received response.
      RESP2R     : aliased STM32H753.UInt32;
      --  The SDMMC_RESP1/2/3/4R registers contain the status of a card, which
      --  is part of the received response.
      RESP3R     : aliased STM32H753.UInt32;
      --  The SDMMC_RESP1/2/3/4R registers contain the status of a card, which
      --  is part of the received response.
      RESP4R     : aliased STM32H753.UInt32;
      ...
      --  set.
      DTIMER     : aliased STM32H753.UInt32;
      --  The SDMMC_DLENR register contains the number of data bytes to be
      --  transferred. The value is loaded into the data counter when data
      --  transfer starts.
      ...
      FIFOR      : aliased STM32H753.UInt32;
      --  SDMMC IP version register
      VER        : aliased VER_Register;
      --  SDMMC IP identification register
      ID         : aliased STM32H753.UInt32;
   end record
     with Volatile;
