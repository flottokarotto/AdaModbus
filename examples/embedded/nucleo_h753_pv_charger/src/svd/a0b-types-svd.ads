--  A0B.Types.SVD - Minimal type definitions for SVD-generated packages
--
--  This provides the base types used by svd2ada-generated register definitions.
--  Only the types actually used by the STM32H753 SVD bindings are included.
